...
void Multiply2MatrixInThird(short Matrix1[3][3], short Matrix2[3][3], short Matrix3[3][3], short rows, short cols)
{
    for (short i = 0; i < rows; i++)
    {
        for (short j = 0; j < cols; j++)
...
int main()
{
    ...
    cout << "This is the Multiplication of matrix 1 and 2 : \n\n";

    Multiply2MatrixInThird(Matrix1,Matrix2,Matrix3,3,3);
